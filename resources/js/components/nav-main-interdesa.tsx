    ...
    <nav className="p-4 space-y-6">
      ...
      <div>
        ...
        <div className="mt-2 space-y-2">
          <NavLink href={`/unit/${unitId}/pemasukan-interdesa`} icon={ArrowUpRight} label="Pemasukan" />
          <NavLink href={`/unit/${unitId}/pengeluaran-interdesa`} icon={ArrowDownLeft} label="Pengeluaran" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="mt-2 space-y-2">
          <NavLink href={`/unit/${unitId}/kelolalaporan-interdesa`} icon={FileText} label="Kelola laporan" />
        </div>
      </div>
