...
const Legalitas: React.FC = () => {
    const { dokumenLegalitas } = usePage<PageProps>().props;
            ...
            <section className="bg-white py-20">
                ...
                >
                    ...
                    <div className="space-y-4">
                        {dokumenLegalitas.map((doc, idx) => (
                            <div key={doc.id} className="overflow-hidden rounded-xl border border-blue-200 shadow-sm">
                                <button
                                ...
                                {openIndex === idx && (
                                    <div className="border-t bg-white p-6">
                                        <img
                                            src={doc.document_image ? `/storage/${doc.document_image}` : '/assets/images/no-image.png'}
                                            alt={`Foto ${doc.name}`}
