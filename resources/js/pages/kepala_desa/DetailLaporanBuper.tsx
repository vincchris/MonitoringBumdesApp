...
export default function DetailLaporanMiniSoccer() {
    ...
    const handleExportPDF = async () => {
        try {
            ...
            try {
                ...
                const downloadUrl = route('buper.downloadPdfDetail', { bulan: encodeURIComponent(bulanParam) });
    ...
    const handleExportExcel = async () => {
        try {
            ...
            window.location.href = route('buper.downloadExcelDetail', { bulan: bulanParam });
        } catch (error) {
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <Card className="p-4 shadow-sm">
                        <CardHeader className="px-6 py-2">
                            ...
                            <p className="mt-2 text-sm text-gray-500">Menampilkan semua transaksi yang terjadi pada bulan {bulan}</p>
                        </CardHeader>
