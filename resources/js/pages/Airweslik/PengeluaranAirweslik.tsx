...
export default function PengeluaranAirweslik({ user, unit_id, pengeluaran, pagination }: Props) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        const url = editing === null ? `/unit/${unit_id}/pengeluaran-airweslik` : `/unit/${unit_id}/pengeluaran-airweslik/${editing}`;
    ...
    const handleDelete = (id: number) => {
        if (confirm('Yakin ingin menghapus data ini?')) {
            router.delete(`/unit/${unit_id}/pengeluaran-airweslik/${id}`);
        }
    };
        ...
        <AppLayout>
            ...
            <div className="rounded-2xl bg-white px-2 py-4">
                <div className="mt-3 mb-4 flex items-center justify-between px-6">
                    <h2 className="text-xl font-semibold text-gray-800">Pengeluaran - Air Weslik</h2>
