        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="rounded-2xl bg-white px-2 py-4">
                ...
                <div className="mb-4 flex justify-end gap-2 px-6">
                    <a href={`/unit/${unit_id}/kelolalaporan-airweslik/export-pdf`} className="rounded-md bg-red-500 px-4 py-2 text-white hover:bg-red-600">
                        Download PDF
                    </a>
                    <a
                        href={`/unit/${unit_id}/kelolalaporan-airweslik/export-excel`}
