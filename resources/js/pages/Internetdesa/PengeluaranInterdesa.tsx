...
export default function PengeluaranBuper({ user, unit_id, pengeluaran, pagination }: Props) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        const url = editing === null ? `/unit/${unit_id}/pengeluaran-interdesa` : `/unit/${unit_id}/pengeluaran-interdesa/${editing}`;
    ...
    const handleDelete = (id: number) => {
        if (confirm('Yakin ingin menghapus data ini?')) {
            router.delete(`/unit/${unit_id}/pengeluaran-interdesa/${id}`);
        }
    };
    ...
    const handlePageChange = (page: number) => {
        router.get(
            `/unit/${unit_id}/pengeluaran-interdesa`,
            { page },
            {
                preserveState: true,
                preserveScroll: true,
    ...
    return (
        <AppLayout>
            <Head title="Pengeluaran Internet Desa" />
            {flashMessage && (
                <div
            ...
            <div className="rounded-2xl bg-white px-2 py-4">
                <div className="mt-3 mb-4 flex items-center justify-between px-6">
                    <h2 className="text-xl font-semibold text-gray-800">Pengeluaran - Internet Desa</h2>
