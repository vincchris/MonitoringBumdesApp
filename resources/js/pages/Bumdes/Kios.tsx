        ...
        <AppLayout>
            ...
            <div className="min-h-screen bg-gray-50 px-4 py-6 sm:px-6 lg:px-8">
                ...
                <header className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">Unit Usaha - Kios</h1>
                    <p className="mt-2 text-sm text-gray-600">Kelola kKuangan dan Operasional Sewa Kios Anda</p>
                </header>
