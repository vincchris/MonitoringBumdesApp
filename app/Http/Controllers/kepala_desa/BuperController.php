...
class BuperController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('kepala_desa/Buper', [
            'auth' => [
    ...
    public function downloadPdfDetail($bulan)
    {
        try {
            ...
            try {
                ...
                $filename = "Detail-Transaksi-Bumi-Perkemahan-{$year}-{$month}.pdf";
    ...
    public function downloadExcelDetail($bulan)
    {
        try {
            ...
            $filename = "Detail-Transaksi-Bumi-Perkemahan-{$year}-{$month}.xlsx";
    ...
    public function show($bulan)
    {
        ...
        return Inertia::render('kepala_desa/DetailLaporanBuper', [
            'auth' => [
                'user' => Auth::user()->only(['name', 'roles', 'image']),
            ],
