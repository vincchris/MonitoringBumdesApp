...
class KiosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('kepala_desa/Kios', [
            'auth' => [
    ...
    public function downloadPdfDetail($bulan)
    {
        try {
            ...
            try {
                ...
                $filename = "Detail-Transaksi-Kios-{$year}-{$month}.pdf";
    ...
    public function downloadExcelDetail($bulan)
    {
        try {
            ...
            $filename = "Detail-Transaksi-Kios-{$year}-{$month}.xlsx";
    ...
    public function show($bulan)
    {
        ...
        return Inertia::render('kepala_desa/DetailLaporanKios', [
            'auth' => [
                'user' => Auth::user()->only(['name', 'roles', 'image']),
            ],
